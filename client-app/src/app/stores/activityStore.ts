import { makeAutoObservable, reaction, runInAction, _allowStateChangesInsideComputed } from "mobx";
...
export default class ActivityStore {
     ...
     setPredicate = (predicate: any, value: string | Date) => {
          const resetPred = () => {
          ...
          switch (predicate) {
               ...
               case 'food':
                    resetPred();
                    this.predicate.set('category', 'food')
                    break;
               case 'music':
                    resetPred();
                    this.predicate.set('category', 'music')
                    break;
               case 'travel':
                    resetPred();
                    this.predicate.set('category', 'travel')
                    break;
               case 'recreational':
                    resetPred();
                    this.predicate.set('category', 'recreational')
                    break;
               case 'social':
                    resetPred();
               ...
               case 'education':
                    resetPred();
                    this.predicate.set('category', 'education')
                    break;
               case 'search':
                    resetPred();
